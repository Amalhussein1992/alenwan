...
@section('title', __('admin.add_new_documentary'))
...
<div class="container-fluid p-0">
    ...
    <div class="mb-4 animate-fade-in">
        <div class="row align-items-center">
            <div class="col">
                <h1 class="h3 mb-0" style="color: var(--text-primary); font-weight: 700;">{{ __('admin.add_new_documentary') }}</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><a href="/admin/dashboard">{{ __('admin.dashboard') }}</a></li>
                        <li class="breadcrumb-item"><a href="/admin/documentaries">{{ __('admin.documentaries') }}</a></li>
                        <li class="breadcrumb-item active">{{ __('admin.add_new') }}</li>
                    </ol>
                </nav>
            </div>
            <div class="col-auto">
                <a href="/admin/documentaries" class="btn-modern btn-secondary-modern">
                    <i class="fas fa-arrow-left me-2"></i>{{ __('admin.back_to_documentaries') }}
                </a>
            </div>
        </div>
    </div>

    <form method="POST" action="{{ route('admin.documentaries.store') }}" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <!-- Left Column -->
            <div class="col-xl-8">
                ...
                <div class="card-modern mb-4 animate-slide-in">
                    ...
                    <div class="mb-3">
                        <label class="form-label">{{ __('admin.documentary_title') }} *</label>
                        <input type="text" name="title" class="form-control @error('title') is-invalid @enderror"
                               placeholder="{{ __('admin.enter_documentary_title') }}" value="{{ old('title') }}" required
                    ...
                    <div class="mb-3">
                        ...
                        <input type="url" name="video_url" class="form-control @error('video_url') is-invalid @enderror"
                               placeholder="https://example.com/documentary.mp4" value="{{ old('video_url') }}"
                               style="border-radius: 10px;">
                        @error('video_url')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
            ...
            <div class="col-xl-4">
                ...
                <div class="card-modern animate-slide-in" style="animation-delay: 0.2s;">
                    <h5 class="mb-4" style="color: var(--text-primary); font-weight: 600;">
                        <i class="fas fa-image me-2 text-danger"></i>{{ __('admin.documentary_poster') }}
                    </h5>
            ...
            <div class="col-12">
                <div class="card-modern animate-fade-in">
                    <div class="d-flex justify-content-between">
                        <div>
                            <a href="/admin/documentaries" class="btn btn-outline-danger">
                                <i class="fas fa-times me-2"></i>{{ __('admin.cancel') }}
                            </a>
                        </div>
                        <div>
                            <button type="submit" class="btn-modern btn-success-modern">
                                <i class="fas fa-check me-2"></i>{{ __('admin.add_documentary') }}
                            </button>
                        </div>
                    </div>
                </div>
