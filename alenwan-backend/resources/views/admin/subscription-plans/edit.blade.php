...
<div class="container-fluid p-0">
    ...
    <div class="mb-4 animate-fade-in">
        <div class="row align-items-center">
            <div class="col">
                <h1 class="h3 mb-0" style="color: var(--text-primary); font-weight: 700;">{{ __('admin.edit_subscription_plan') }}</h1>
        ...
        <form action="{{ route('admin.subscription-plans.update', $plan->id) }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('max_devices') is-invalid @enderror" id="max_devices" name="max_devices" value="{{ old('max_devices', $plan->max_devices) }}">
                        @error('max_devices')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('features') is-invalid @enderror" id="features" name="features" rows="5" placeholder="Enter features, one per line">{{ old('features', is_array($plan->features) ? implode("\n", $plan->features) : '') }}</textarea>
            ...
            <div class="d-flex gap-2">
                <button type="submit" class="btn-modern btn-success-modern">
                    <i class="fas fa-save me-2"></i>{{ __('admin.update_plan') }}
                </button>
