...
<div class="container-fluid p-0">
    ...
    <div class="mb-4 animate-fade-in">
        <div class="row align-items-center">
            <div class="col">
                <h1 class="h3 mb-0" style="color: var(--text-primary); font-weight: 700;">{{ __('admin.add_new_category') }}</h1>
                ...
                <div class="card-modern mb-4 animate-slide-in">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                               placeholder="{{ __('admin.enter_category_name') }}" value="{{ old('name') }}" required
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name_ar" class="form-control @error('name_ar') is-invalid @enderror"
                               placeholder="#/.D '3E 'DA&)" value="{{ old('name_ar') }}" dir="rtl"
                               style="border-radius: 10px;">
                        @error('name_ar')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="description_ar" rows="4" class="form-control @error('description_ar') is-invalid @enderror"
                                  placeholder="#/.D H5A 'DA&)" dir="rtl" style="border-radius: 10px;">{{ old('description_ar') }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="icon" class="form-control @error('icon') is-invalid @enderror"
                                   placeholder="fa-folder" value="{{ old('icon', 'fa-folder') }}"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="color" name="color" class="form-control form-control-color @error('color') is-invalid @enderror"
                               value="{{ old('color', '#667eea') }}" style="border-radius: 10px; width: 100px; height: 50px;">
                        @error('color')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div>
                            <button type="submit" class="btn-modern btn-success-modern">
                                <i class="fas fa-check me-2"></i>{{ __('admin.add_category') }}
                            </button>
                        </div>
                    </div>
                </div>
